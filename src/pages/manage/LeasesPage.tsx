...
function openWhatsApp(number: string | null | undefined, message: string) {
                      ...
                      <button
                        onClick={(e) => {
                          ...
                          const asset = lease.unit
                            ? `${lease.unit.unitNumber} — ${lease.unit.property.name}`
                            : `Carpark ${lease.carpark?.carparkNumber}`;
                          openWhatsApp(lease.company!.whatsappNumber, `Dear ${lease.company!.name}, we would like to touch base regarding your lease for ${asset}. Please feel free to reach out if you have any questions. Thank you.`);
                        }}
                        className="p-1 text-green-500 hover:text-green-600 rounded shrink-0"
                      ...
                      <button
                        onClick={(e) => {
                          ...
                          const asset = lease.unit
                            ? `${lease.unit.unitNumber} — ${lease.unit.property.name}`
                            : `Carpark ${lease.carpark?.carparkNumber}`;
                          openWhatsApp(lease.customer!.whatsappNumber, `Dear ${lease.customer!.name}, we would like to touch base regarding your lease for ${asset}. Please feel free to reach out if you have any questions. Thank you.`);
                        }}
                        className="p-1 text-green-500 hover:text-green-600 rounded shrink-0"
                        title="Contact via WhatsApp"
                      >
